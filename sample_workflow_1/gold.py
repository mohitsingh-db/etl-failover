...
gold_table_path = "s3://one-env-uc-external-location/mohit/east/data/main/workflow_1_gold"  
database_name = "humana.main" 
...
silver_df = spark.read.table("humana.stage.workflow_1_silver")
